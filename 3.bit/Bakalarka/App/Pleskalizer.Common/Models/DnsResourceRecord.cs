...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class DnsResourceRecord : IEquatable<DnsResourceRecord>
    {
        public DnsResourceRecord(TypeEnum? type, string target, string name)
        {
            Type = type;
            Target = target;
            Name = name;
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((DnsResourceRecord)obj);
        }

        /// <summary>
        /// Returns true if DnsResourceRecord instances are equal
        /// </summary>
        /// <param name="other">Instance of DnsResourceRecord to be compared</param>
        /// <returns>Boolean</returns>
        ...
        public static bool operator ==(DnsResourceRecord left, DnsResourceRecord right)
        {
