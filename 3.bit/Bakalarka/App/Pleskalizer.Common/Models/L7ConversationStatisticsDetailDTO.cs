...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class L7ConversationStatisticsDetailDTO : IEquatable<L7ConversationStatisticsDetailDTO>
    {
        public L7ConversationStatisticsDetailDTO(Guid? captureId, string addressA, string addressB, int? portA, int? portB, ProtocolL3Enum? protocolL3, ProtocolL4Enum? protocolL4, string protocolL7, Guid? sessionId, List<FlowStatisticsSnapshotDTO> aToBFlowStatisticsSnapshots, List<FlowStatisticsSnapshotDTO> bToAFlowStatisticsSnapshots)
        {
            CaptureId = captureId;
            AddressA = addressA;
            AddressB = addressB;
            ...
            SessionId = sessionId;
            AToBFlowStatisticsSnapshots = aToBFlowStatisticsSnapshots;
            BToAFlowStatisticsSnapshots = bToAFlowStatisticsSnapshots;
        }

        public L7ConversationStatisticsDetailDTO()
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class L7ConversationStatisticsDetailDTO {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((L7ConversationStatisticsDetailDTO)obj);
        }

        /// <summary>
        /// Returns true if L7ConversationStatisticsDetailDTO instances are equal
        /// </summary>
        /// <param name="other">Instance of L7ConversationStatisticsDetailDTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(L7ConversationStatisticsDetailDTO other)
        {
        ...
        public static bool operator ==(L7ConversationStatisticsDetailDTO left, L7ConversationStatisticsDetailDTO right)
        {
