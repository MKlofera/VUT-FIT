    ...
    public partial class InitialMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FoodOrderNotes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_FoodOrderNotes_Foods_FoodId",
                        column: x => x.FoodId,
                        principalTable: "Foods",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_FoodOrderNotes_Orders_OrderId",
                        column: x => x.OrderId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FoodOrderNotes_FoodId",
                table: "FoodOrderNotes",
                column: "FoodId");

            migrationBuilder.CreateIndex(
                name: "IX_FoodOrderNotes_OrderId",
                table: "FoodOrderNotes",
                column: "OrderId");
