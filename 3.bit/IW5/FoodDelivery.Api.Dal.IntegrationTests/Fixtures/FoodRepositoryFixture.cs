...
public class FoodRepositoryFixture : IDisposable, IDatabaseFixture
{
    public readonly FoodRepository repository;

    public FoodRepositoryFixture()
    {
        PrepareDatabase();
        repository = new FoodRepository(CreateDbContext());
    }
